...
async function start(): Promise<void> {
  ...
  // Issue #36: start the subscription auto-renewal cron.
  // The store is wired to Prisma via a thin adapter so we reuse the existing
  // ORM connection pool and avoid a second database connection.
