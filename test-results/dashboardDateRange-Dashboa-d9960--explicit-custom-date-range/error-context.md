...
- Name: dashboardDateRange.spec.ts >> Dashboard Billing Date Range >> renders data scoped to an explicit custom date range
- Location: tests/e2e/dashboardDateRange.spec.ts:59:7
...
Locator: getByText('Total Usage (2026-01-01 to 2026-06-01)')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Total Usage (2026-01-01 to 2026-06-01)')
