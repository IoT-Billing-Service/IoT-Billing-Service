...
import { Landmark, ShieldAlert, Zap, PlusCircle, ArrowUpRight, Gauge, Layers, Info } from 'lucide-react';
...
export default function EscrowList({
  ...
  const [editingBaseRate, setEditingBaseRate] = useState<string>(tariffs[0].baseRatePerPayload.toString());
  const [editingGasBuffer, setEditingGasBuffer] = useState<string>(tariffs[0].gasBuffer.toString());
